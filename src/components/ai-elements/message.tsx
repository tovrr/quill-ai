...
// text-foreground, bg-muted, text-muted-foreground) replaced with the
...
export const MessageContent = ({ children, className, ...props }: MessageContentProps) => (
  <div
    className={cn(
      ...
      "group-[.is-user]:ml-auto group-[.is-user]:rounded-lg group-[.is-user]:bg-quill-accent group-[.is-user]:px-4 group-[.is-user]:py-3 group-[.is-user]:text-white",
      "group-[.is-assistant]:text-quill-text",
      className,
    )}
    {...props}
  >
...
export const MessageBranchPrevious = ({ children, ...props }: MessageBranchPreviousProps) => {
  ...
  return (
    <Button
      ...
      {...props}
    >
      {children ?? <ChevronLeftIcon className="h-3.5 w-3.5" aria-hidden="true" />}
    </Button>
  );
};
...
export const MessageBranchNext = ({ children, ...props }: MessageBranchNextProps) => {
  ...
  return (
    <Button
      ...
      {...props}
    >
      {children ?? <ChevronRightIcon className="h-3.5 w-3.5" aria-hidden="true" />}
    </Button>
  );
};
...
export const MessageBranchPage = ({ className, ...props }: MessageBranchPageProps) => {
  ...
  return (
    <ButtonGroupText
      className={cn("border-none bg-transparent text-quill-muted shadow-none", className)}
      {...props}
    >
